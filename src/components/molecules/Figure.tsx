...
export const Figure: React.FC<FigureProps> = ({
    ...
    // Width-capped and centered: figures read at ciechanow.ski scale
    // (~560px-tall drawings) even inside the wide `xl` content column — an
    ...
    return (
        <figure
            data-figure-id={id}
            className={cn("group mx-auto w-full max-w-[660px]", className)}
        >
            <div
